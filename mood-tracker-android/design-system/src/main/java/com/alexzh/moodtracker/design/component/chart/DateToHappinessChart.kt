...
fun DateToHappinessChart(
    ...
    val iconPainterAngryIcon =
        rememberVectorPainter(ImageVector.vectorResource(happinessIndicators.angryIconRes))
    val iconPainterConfusedIcon =
        rememberVectorPainter(ImageVector.vectorResource(happinessIndicators.confusedIconRes))
    val iconPainterNeutralIcon =
        rememberVectorPainter(ImageVector.vectorResource(happinessIndicators.neutralIconRes))
    val iconPainterHappyIcon =
        rememberVectorPainter(ImageVector.vectorResource(happinessIndicators.happyIconRes))
    val iconPainterExcitedIcon =
        rememberVectorPainter(ImageVector.vectorResource(happinessIndicators.excitedIconRes))
